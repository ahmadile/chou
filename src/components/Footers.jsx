...
export default function Footer() {
  ...
  return (
    <footer className="min-h-screen flex items-center justify-center relative bg-gradient-to-b from-blue-400 to-purple-800">
      {/* Soleil */}
      <motion.img
        src="/images/w/luneRouge.png"
        alt="Soleil"
        className="absolute w-16 sm:w-20 md:w-28 lg:w-36 h-auto right-5 top-10 sm:top-20"
        style={{ opacity: opacitySun }}
      />
      ...
      <motion.img
        src="/images/w/croissantLune.png"
        alt="Lune orange"
        className="absolute w-16 sm:w-20 md:w-28 lg:w-36 h-auto right-5  transform -translate-y-1/2 top-32"
        style={{ opacity: opacityMoonOrange }}
      />
      ...
      {/* Boîte de texte */}
      <div className="relative z-10 bg-white/30 backdrop-blur-md shadow-2xl w-11/12 sm:w-9/12 md:w-2/3 lg:w-1/2 p-5 rounded-lg mx-auto mt-10 sm:mt-20 translate-y-20">
        <img
          src="/images/w/bazinChouk.png"
          alt="Bazin"
          className="float-right w-16 sm:w-20 md:w-24 lg:w-32 h-auto ml-4 mb-2"
        />
        <p className="text-cyan-50 text-sm sm:text-base md:text-lg lg:text-xl ">
          À l&apos;image du soleil couchant qui peint le ciel de couleurs
          magnifiques, puisse ta vie être remplie de moments précieux et de
          bénédictions. Que la sérénité et la paix qui accompagnent la fin de
          chaque journée t&apos;entourent toujours, et que la lumière
          d&apos;Allah brille constamment sur ton chemin. Nous prions pour que
          chaque soir soit un rappel de la grâce et de la miséricorde
          d&apos;Allah, et que ton cœur soit toujours guidé par sa lumière
          divine.
          <br />
          <strong>Amine.</strong>
        </p>
